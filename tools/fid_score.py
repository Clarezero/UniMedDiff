...
if __name__ == '__main__':
    data_root = '/storage/ScientificPrograms/Diffusion/data/NLMCXR/resized_256'
    save_path = '/storage/ScientificPrograms/Diffusion/code/U-ViT-main/assets/fid_stats/fid_stats_MIMIC.npz'
